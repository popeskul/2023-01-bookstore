...
@Aspect
@Component
public class AuthorDaoJdbcLoggingAspect {
    private static final Logger logger = LoggerFactory.getLogger(AuthorDaoJdbcLoggingAspect.class);

    @Around("execution(* com.otus.bookstore.dao.impl.AuthorDaoJdbc.*(..))")
